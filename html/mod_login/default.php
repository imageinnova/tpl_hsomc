...
<form action="<?php echo JRoute::_(JUri::getInstance()->toString(), true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline">
	...
	<div class="userdata">
		<div id="form-login-username" class="input-group">
			...
			<span class="input-group-addon"><span class="glyphicon glyphicon-user" title="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>"></span></span>
		...
		<div id="form-login-password" class="input-group">
			...
			<span class="input-group-addon"><span class="glyphicon glyphicon-lock" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>"></span></span>
